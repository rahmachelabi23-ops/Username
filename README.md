...
📂 Featured Projects
- **Student Attendance Management System:** A modular C-based application with advanced file handling.
- **Data Cleaning Pipeline:** Processing and structuring 120k+ records using SQL queries.
- **Power BI Dashboards:** Visualizing complex performance metrics into interactive reports.
